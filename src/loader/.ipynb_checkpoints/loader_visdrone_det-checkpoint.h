#ifndef LOADER_VISDRONE_DET_H
#define LOADER_VISDRONE_DET_H

#include "helper/bounding_box.h"
#include "loader_imagenet_det.h"
...
class LoaderVisdroneDet
{
public:
  // Load all annotations.
  LoaderVisdroneDet(const std::string& image_folder,
